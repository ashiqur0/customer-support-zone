...
const Banner = ({ props }) => {
    ...
    return (
        <div className='my-5 md:my-20 flex flex-col md:flex-row gap-4 items-center max-w-330 mx-auto text-center text-white px-5'>
            ...
            <div className={`bg-gradient-to-r from-lime-300 via-green-400 to-emerald-500
                md:w-1/2 w-full  rounded-[6px] md:rounded-2xl flex items-center justify-between`}>
                <img className='md:w-2/5 w-1/3' src={img} alt="" />
                <div className='flex flex-col gap-2 md:gap-4'>
